<?php
if (basename($_SERVER['PHP_SELF']) == 'gestisci_rank_mob.php') {
...
<button class="button button_delete" name="delete_ge" style="margin-left: 1%; width: 290px; float: left"
    onclick="return confirm('Sei sicuro di voler eliminare?');">Cancella posizioni selezionate</button>
</form>

<div class="small_container" style="margin-top: 20%; height: 400px">
    <table class="tabella" style="margin-top: 2%">
        <thead>
            <header>
                <p style="float: left">
...
<button class="button button_delete" name="delete_ch" style="margin-left: 1%; width: 290px; float: left"
    onclick="return confirm('Sei sicuro di voler eliminare?');">Cancella posizioni selezionate</button>
</form>