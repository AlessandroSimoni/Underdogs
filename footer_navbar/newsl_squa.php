...
if (basename($_SERVER['PHP_SELF']) == 'newsl_squa.php') {
...
$sql = mysqli_prepare($conn, "SELECT * FROM squadra WHERE email = ?");
...
if (isset($_POST['subscribe'])) {
    include('../connection.php');
    $newsletter = 1;
    $stmt = mysqli_prepare($conn, "UPDATE squadra SET newsletter=? WHERE email=?");
